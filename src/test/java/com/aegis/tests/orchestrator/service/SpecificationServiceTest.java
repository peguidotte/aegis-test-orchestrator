package com.aegis.tests.orchestrator.service;

import com.aegis.tests.orchestrator.exception.ApiCallIdRequiredException;
import com.aegis.tests.orchestrator.exception.ApiCallInvalidException;
import com.aegis.tests.orchestrator.exception.ApiCallNotFoundException;
import com.aegis.tests.orchestrator.exception.AuthProfileInvalidException;
import com.aegis.tests.orchestrator.exception.AuthProfileRequiredException;
import com.aegis.tests.orchestrator.exception.DomainNotFoundException;
import com.aegis.tests.orchestrator.exception.EnvironmentNotFoundException;
import com.aegis.tests.orchestrator.exception.ManualInputRequiredException;
import com.aegis.tests.orchestrator.exception.SpecificationAlreadyExistsException;
import com.aegis.tests.orchestrator.exception.SupportingApiCallInvalidException;
import com.aegis.tests.orchestrator.exception.TestProjectNotFoundException;
...
import com.aegis.tests.orchestrator.model.entity.ApiCall;
import com.aegis.tests.orchestrator.model.entity.AuthProfile;
import com.aegis.tests.orchestrator.model.entity.BaseUrl;
import com.aegis.tests.orchestrator.model.entity.BearerTokenCredentials;
import com.aegis.tests.orchestrator.model.entity.Domain;
import com.aegis.tests.orchestrator.model.entity.Environment;
...
import com.aegis.tests.orchestrator.repository.*;
import com.aegis.tests.orchestrator.services.SpecificationService;
import com.aegis.tests.orchestrator.services.messaging.SpecificationEventPublisherBase;
