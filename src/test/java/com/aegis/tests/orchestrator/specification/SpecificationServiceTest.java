...
import com.aegis.tests.orchestrator.authprofile.BearerTokenCredentials;
...
class SpecificationServiceTest {
    ...
    class ManualModeTests {
        ...
        void shouldCreateSpecificationWithManualInput() {
            ...
            Specification savedSpec = createManualSpecification(500L, validManualRequest, SpecificationStatus.CREATED);
            ...
            assertThat(response.status()).isEqualTo(SpecificationStatus.CREATED);
        ...
        void shouldSetWaitingApprovalStatus() {
            ...
            Specification savedSpec = createManualSpecification(500L, requestWithApproval, SpecificationStatus.WAITING_APPROVAL);
            when(specificationRepository.save(any(Specification.class))).thenReturn(savedSpec);
    ...
    class ApiCallModeTests {
        ...
        void shouldCreateSpecificationWithApiCallInput() {
            ...
            Specification savedSpec = createApiCallSpecification(500L, validApiCallRequest, SpecificationStatus.CREATED);
            when(specificationRepository.save(any(Specification.class))).thenReturn(savedSpec);
        ...
        void shouldUseDomainFromRequestWhenProvided() {
            ...
            Specification savedSpec = Specification.builder()
                    ...
                    .status(SpecificationStatus.CREATED)
    ...
    private Specification createManualSpecification(Long id, CreateSpecificationRequestDTO request, SpecificationStatus status) {
    ...
    private Specification createApiCallSpecification(Long id, CreateSpecificationRequestDTO request, SpecificationStatus status) {
        Instant now = Instant.now();
        return Specification.builder()
                .id(id)
                .inputType(SpecificationInputType.API_CALL)
